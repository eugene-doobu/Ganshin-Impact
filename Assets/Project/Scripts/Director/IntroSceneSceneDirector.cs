...
namespace GanShin.Director.IntroScene
{
    ...
    {
        [Inject]
        IntroSceneSettingInstaller.BridgeSettings _bridgeSettings = null!;
        
        [Inject]
        IntroSceneSettingInstaller.BridgePrefabs _bridgePrefabs = null!;
...
#region MonoBehaviour
        ...
        private void Start()
        {
            for (var i = 0; i < _bridgeSettings.numberOfBridge; ++i)
            {
                ...
                var obj = Instantiate(rand >= _bridgeSettings.bridge1SpawnRate ? _bridgePrefabs.bridge2 : _bridgePrefabs.bridge1);
                ...
                {
                    rand = Random.Range(0, 1f);
                    var pillar = Instantiate(rand >= _bridgeSettings.pillar1SpawnRate + _bridgeSettings.pillar2SpawnRate ?
                        _bridgePrefabs.pillar3 : rand >= _bridgeSettings.pillar1SpawnRate ? _bridgePrefabs.pillar2 : _bridgePrefabs.pillar1,
                        obj.transform, true);
