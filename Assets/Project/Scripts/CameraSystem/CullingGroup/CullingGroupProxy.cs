...
#region InspectorFields
        ...
        private eCullingGroupType _cullingGroupType = eCullingGroupType.OBJECT_HUD;

        [SerializeField]
        eCullingTargetUpdateMode _targetsUpdateMode = eCullingTargetUpdateMode.EVERY_UPDATE;
...
#region MonoBehaviour
	    ...
	    private void Update()
	    {
		    if (_targetsUpdateMode == eCullingTargetUpdateMode.EVERY_UPDATE)
		    {
			    UpdateTargets();
		    }
