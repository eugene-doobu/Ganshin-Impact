...
namespace GanShin.Data
{
    ...
    {
        [Header("Attack")] public float rikoAttackForwardOffset = 0.5f;

        public float rikoAttackRadius         = 1.5f;
        public float rikoUltimateAttackRadius = 2.5f;
        public float rikoSkillAttackRadius    = 2.5f;

        [Header("Camera Shake")] public float rikoBaseAttackShakeForce = 0.05f;
        ...
        [Header("Attack Delay")] public float attack1Delay = 1f;
        ...
        [Header("Ultimate")] public Vector3 ultimateSwordScale = new(1.4f, 1.4f, 1f);
