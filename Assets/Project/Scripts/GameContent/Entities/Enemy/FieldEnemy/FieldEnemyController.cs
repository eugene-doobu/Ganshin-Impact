...
namespace GanShin.Entities.Enemy.FieldEnemy
{
    ...
    public class FieldEnemyController : EnemyController, IDataContextOwner
    {
        ...
        private FieldEnemyAnimBase _animController = null!;
...
#region MonoBehaviour
        protected override void Awake()
        {
            ...
            {
                case eFieldEnemyType.DEFAULT:
                    _animController = new FieldEnemyAnimatorController();
                    break;
                case eFieldEnemyType.HUMANOID:
        ...
        public override void OnDamaged(float damage)
        {
            ...
            CurrentHp -= damage;
            GanDebugger.Log(nameof(FieldEnemyController), $"{gameObject.name} OnDamaged : {_currentHp}");
